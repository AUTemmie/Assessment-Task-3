...
<h1>Week 5<h1>
<p>
<li>what data do you want stored during the use of your app? </li>
<li>what date you want displayed on your front end?</li>
<li>what data is related to each other - needing keys set-up for each table</li>
<li>what data types should for elements be in your database (text, numeric, image etc)</li>
<li>what queries might you need to write (between and across tables) allowing for good information storage and retrieval</li>
</p>
