...
For users: First Name, Last Name, email, password, gender, UserID. For Conversation: ConversationID, UserID, Message Text, Message Sent Date. For </li>

<li><strong>what date you want displayed on your front end?</strong></li>

<li><strong>what data is related to each other - needing keys set-up for each table</strong></li>

<li><strong>what data types should for elements be in your database (text, numeric, image etc)</strong></li>

<li><strong>what queries might you need to write (between and across tables) allowing for good information storage and retrieval</strong></li>
