...
<p>The use of AI was implemented when difficulty arose. This is especially shown in the javascript parts of the files such as the login, signup page and search bar which I used AI for.
